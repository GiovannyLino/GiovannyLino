<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&size=32&duration=3000&pause=1000&color=00FF00&center=true&vCenter=true&width=600&lines=Desenvolvedor+Web;Cloud+%26+DevOps;Ciencia+da+Computacao" alt="Typing SVG Matrix Style" />
</p>

<p align="center">
  🔭 Graduando em Ciência da Computação (USCS) 📡<br/>
  🖥️ Construindo projetos FullStack, provas de conceito (PoCs) e explorando arquiteturas em Nuvem 🖥️<br/>
</p>
...
- 🛡️ Entusiasta da área de **Cybersecurity** (Splunk SOAR, mitigação de vulnerabilidades) e Infraestrutura de Redes (Cisco IOS, modelo OSI/TCP-IP).
- 🎮 Quando não estou programando ou configurando servidores, provavelmente estou jogando Minecraft.
- 📁 Veja meus projetos, incluindo meu portfólio hospedado na Vercel, em: [github.com/GiovannyLino](https://github.com/GiovannyLino)
- 💬 Compartilho conquistas acadêmicas, de carreira e estudos de caso em Inglês no meu [LinkedIn](https://www.linkedin.com/in/giovanny-lino-a54660179/)
...
<p align="center">
  <img width="36.4%" src="https://github-readme-stats.vercel.app/api/top-langs/?username=GiovannyLino&layout=compact&langs_count=8&theme=radical" alt="Top Languages" />
